...
def timer():
	...
	###
	d = "++"
	d = ultrasound.calculte()
	print (colored("Distance: %s"%d, 'green'))
	#z = gyroCompass.readSensor()
	if kompassEnabled == 1:
		bluetoothMessage = "d=%s!" % (d)
	else:
		bluetoothMessage = "x=%.3f--y=%.3f--z=180.00!" % (2, 2)
...
if __name__ == '__main__':
	...
	try:
		...
		parser.add_argument('--ultrasound', dest ='k_enabled', default = False, action='store_true', help = "Enable the compass sensor." )
		parser.add_argument('--kein-ultrasound', dest ='k_enabled', default = False, action='store_false', help = "Disable the compass sensor." )
		...
		print (colored("Something terrible happened!", 'red'))
